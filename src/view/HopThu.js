  ...
  return (
    <SafeAreaView style={{flex:1 ,flexDirection:'column'}}>
          ...
          <View style={{flexDirection:'row'}}>
            <TouchableOpacity style={{flexDirection:'row'}}>
              <View style={{height:50,width:50,marginTop:20,marginLeft:30}}>
                <Image style={{width:'100%',height:'100%'}} source={require('../image/mail.png')} resizeMode='stretch'/>
            ...
            <TouchableOpacity style={{flexDirection:'row'}}>
              <View style={{height:50,width:50,marginTop:20,marginLeft:30}}>
                <Image style={{width:'100%',height:'100%'}} source={require('../image/help.png')} resizeMode='stretch'/>
      ...
      <View style={{height:150,width:'100%'}}>
          ...
          <View style={{flexDirection:'row',width:'100%',height:90,marginTop:10,marginLeft:10}}>
            <Image style={{width:90,height:'100%'}} source={require('../image/icon-messenger.png')} resizeMode='stretch'/>  
